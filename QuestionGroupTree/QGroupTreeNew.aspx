       ...
       function displayFeatureSearchOraddQuestion()
        {
           ...
           if (Opener == "Paper_QuestionType") {
               ...
               $(".featureSearch").css("text-align", "center");
            ...
            <div id="divMain" align="left">
                <table id='body_content' height="85%">                    
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <table class="style1,featureSearch">
                                
                                <tr class="featureSearch">
                                    <td>
                                        <asp:Button ID="btnSearchALLQ_withoutPickingFeature" runat="server" Text="View All Questions in the selected 題庫 without picking features" CssClass="button_continue"  OnClick="btSubmit_Click" />
                                    </br></br></br></br></br></br>
                                        特徵值搜尋：</td>
                                </tr>
                                <tr class="featureSearch">
                                ...
                                <tr class="addOrModifyQuestion">
                                    <td >
                                        <br />
                                        <asp:Button ID="btBack" runat="server" Text="Back" CssClass="button_continue" OnClick="btBack_Click" />&nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="btSubmit" runat="server" Text="Set Up New Question In the Selected 題庫" CssClass="button_continue"  OnClick="btSubmit_Click" />
                                    </td>
                                </tr>
